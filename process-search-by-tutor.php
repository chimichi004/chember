...
/*        $current_user = $_SESSION['user_username'];
        ...
        while($rows = mysqli_fetch_array($result)){ */
          $subject = "select * from user where user_username like '%$tutor%'";
                ...
                <div id="panel-element-<?php echo $rows['user_id']; ?>" class="panel-collapse collapse in">
                  <div class="panel-body">
                    ...
                    <div class="col-md-8 column">
                      <h2><span><a href="profile.php?user_username=<?php echo $rows['user_username'];?>"><br><?php echo $rows['user_firstname'];?> <?php echo $rows['user_lastname'];?></a></span></h2>
                    </div>
                  </div>
                </div>
              </div>
