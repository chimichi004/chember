  ...
  <div class="Login">
    ...
    <form >
      ...
      <div class="submit-button">
        <a href="search-by-tutor.php"><input type="button" value="Tutor Name"></a>
      </div>
      <br>
      <div class="submit-button">
         <a href="search-by-subject.php"><input type="button" value="Subject"></a>
      </div>
       <br>
      <div class="submit-button">
        <a href="search-by-schedule.php"> <input type="button" value="Schedule"></a>
      </div>
