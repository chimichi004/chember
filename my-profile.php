	...
	<div class="profile">
		<div class="row clearfix">
			...
			<div>
				...
				<h2 class="text-center"><?php require_once 'get_reviewcount.php';?></h2>
					...
					<div class="col-lg-9">
						...
						<div id="myTabContent" class="tab-content">
							<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledBy="home-tab"><br>
								...
								<div class="col-md-15 column">
									<table class="table">
										...
										<tbody>
										<tr class="active">
												<td> <p class="profile-details"><i class="fa fa-user"></i>p&nbsp&nbspUserName</p> </td>
												<td> </td></i>
												<td> <p><?php echo $rws['user_username'];?></p> </td>
												<td> </td>
												<td> </td>
											</tr>
											<tr clas
							...
							<div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledBy="profile-tab"><br>
								...
								<input type="hidden" id='review' value="<?php echo $user_username; ?>"></input>  
								<input type="hidden" id='tutor' value="<?php echo $user_username;; ?>"></input> 

								<textarea style="width:100%" style="height:100px" id="comments">
								</textarea><br>
								<div class="row">
									<div class="col-md-6">
										<p class="rating">
